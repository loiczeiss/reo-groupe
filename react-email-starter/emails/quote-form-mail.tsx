...
export const QuoteFormEmail = ({
  ...
  return (
    <Html>
      <Head />
      <Preview>
        Nouveau formulaire de devis - {firstName} {lastName}
      </Preview>
      <Tailwind>
          ...
          <Container className="mx-auto my-10 max-w-[600px]">
              ...
              <Row>
                <Column>
                  ...
                  <Text className="text-white text-sm m-0 opacity-90">
                    Formulaire de devis soumis le {new Date().toLocaleDateString('fr-FR')}
                  </Text>
                </Column>
              </Row>
            </Section>
            ...
            <Section className="bg-white px-8 py-10 rounded-b-lg shadow-lg">
              <Text className="text-[#232548] text-base mb-6">
                ...
                a soumis un nouveau projet via le formulaire de devis. Voici les détails :
              </Text>
