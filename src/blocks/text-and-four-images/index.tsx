...
export function TextAndFourImagesBlock(props: TextAndFourImagesProps) {
  ...
  return (
    <div
      className={
        'w-full max-h-fit flex max-sm:flex-col px-4 sm:px-12 py-6 md:py-16 bg-[50%_35%] md:bg-[47%_83%] font-poppins bg-fixed'
      }
      style={{
    ...
    >
      ...
      <div className={'md:w-1/2 flex flex-col items-center space-y-2 md:space-y-6 overflow-hidden'}>
        <div className={'flex flex-col space-y-1 md:space-y-4 mt-0 md:mt-8 w-full'}>
          ...
          <div className={'max-h-[35vh] overflow-y-auto overscroll-hidden'}>
            <p
              className={
        ...
        <div className={'flex w-full max-w-full overflow-hidden'}>
          ...
          <div className={'flex flex-col max-sm:text-center flex-1 min-w-0 pr-2'}>
            ...
            <div className={'max-h-[25vh] overflow-y-auto'}>
              <p
                className={
                  'max-sm:px-4 text-[10px] md:text-sm leading-none md:leading-tight pr-4 text-pretty'
                }
              >
                {subcontent1}
              </p>
          ...
          <div className={'flex flex-col max-sm:text-center flex-1 min-w-0'}>
            ...
            <div className={'max-h-[20vh] overflow-y-auto'}>
              <p
                className={'max-sm:px-4 text-[10px] md:text-sm leading-none md:leading-tight pr-4'}
              >
                {subcontent2}
              </p>
            </div>
