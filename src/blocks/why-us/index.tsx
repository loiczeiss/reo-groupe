  ...
  return (
    <article className={'w-full flex flex-col md:flex-row px-12 py-10 md:px-0 md:py-7 bg-[#F5F3F3]'}>
      <div className={'flex flex-col justify-start md:justify-center md:w-1/2  md:px-8 md:pr-20'}>
        ...
        <p className={'text-[11px] md:text-sm pt-2 md:pt-4 leading-tight pr-4 md:pr-0'}>{headingGroup.headingDescription}</p>
      </div>
      <div className={'flex flex-col justify-between md:w-1/2 py-8 md:py-0 md:p-8 space-y-4'}>
        <div className={'bg-white px-[11.276px] py-[7.517px] md:py-4 md:px-6 rounded-lg'}>
          <div className={'flex justify-between items-center pb-1 md:pb-4'}>
            <h1 className={'text-sm md:text-2xl text-[#232548] font-semibold'}>
          ...
          <p className={'text-[11px] md:text-sm text-[#232548] leading-tight'}>{subheadingGroup1.subheadingDescription}</p>
        </div>
        <div className={'bg-white px-[11.276px] py-[7.517px] md:py-4 md:px-6 rounded-lg'}>
          <div className={'flex justify-between items-center pb-1 md:pb-4'}>
            <h1 className={'text-sm md:text-2xl text-[#232548] font-semibold'}>
          ...
          <p className={'text-[11px] md:text-sm text-[#232548] leading-tight'}>{subheadingGroup2.subheadingDescription}</p>
        </div>
        <div className={'bg-white px-[11.276px] py-[7.517px] md:py-4 md:px-6 rounded-lg'}>
          <div className={'flex justify-between items-center pb-1 md:pb-4'}>
            <h1 className={'text-sm md:text-2xl text-[#232548] font-semibold'}>
          ...
          <p className={'text-[11px] md:text-sm text-[#232548] leading-tight'}>{subheadingGroup3.subheadingDescription}</p>
        </div>
      </div>
    </article>
  )
