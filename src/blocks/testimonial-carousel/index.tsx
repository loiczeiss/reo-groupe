...
export function TestimonialCarouselBlock(props: TestimonialCarouselBlockProps) {
  ...
  // Calculate total number of pages based on screen size
  const itemsPerPage = {
    mobile: 1,
    tablet: 2,
    desktop: 4,
      ...
      <CardContent className="p-6">
        <div className="flex items-center mb-6">
          <Avatar className="h-14 w-14">
            <AvatarImage src={testimonial.image.url as string || '/placeholder.svg'} alt={testimonial.image.alt} className={'object-cover'}/>
