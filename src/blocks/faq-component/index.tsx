  ...
  return (<main className="bg-[#F5F3F3]">
    <div className="max-w-4xl mx-auto px-4 py-12 ">
      <div className="text-center mb-12">
        <h1 className="text-xl sm:text-3xl md:text-4xl font-bold text-[#2d2d5f] mb-2">{title}</h1>
        ...
        {questionsArray.map((faq, index) => (
          ...
          >
            <button className="flex justify-between items-center w-full p-4 text-left" onClick={() => toggleFAQ(index)}>
              <span className="font-medium max-sm:text-sm text-[#2d2d5f]">{faq.question}</span>
              ...
              <div className="p-4 pt-0 pb-4 text-gray-600">
                  ...
                  <div className="flex">
                    <div className="flex-grow">
                      <p className={'max-sm:text-sm'}>{faq.answer}</p>
                    </div>
